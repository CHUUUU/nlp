...
def words_loss(region_features, words_features, cls_id, use_CUDA=True):
    """
    ...
    for i in range(c.batch_size):
        ...
        """
        weighted_region_features, region_attn = region_attention(batch_1_words_feature, region_features, c.GAMMA1)
